...
class Version20171201120000 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("UPDATE dtb_block_position SET page_id=1, target_id=4, block_row=2, anywhere=1 WHERE  block_id=1;");
        $this->addSql("UPDATE dtb_block_position SET page_id=1, target_id=4, block_row=3, anywhere=1 WHERE  block_id=9;");
        $this->addSql("UPDATE dtb_block_position SET page_id=1, target_id=6, block_row=1, anywhere=0 WHERE  block_id=8;");
        $this->addSql("UPDATE dtb_block_position SET page_id=1, target_id=6, block_row=3, anywhere=0 WHERE  block_id=4;");
